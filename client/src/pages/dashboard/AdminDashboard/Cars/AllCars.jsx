...
//     dispatch(fetchPendingCars());
//     if (filterType === "all") dispatch(fetchApprovedCars());
//   };
...
//     dispatch(fetchPendingCars());
//     if (filterType === "all") dispatch(fetchRejectedCars());
//   };

//   const getCars = () => {
//     if (filterType === "approved") return approved;
//     if (filterType === "pending") return pending;
//     if (filterType === "rejected") return rejected;
//     if (filterType === "all") return [...approved, ...pending, ...rejected];
//     return [];
//   };
...
//           cars={cars}
//           type={filterType}
//           showStatus={filterType === "all"}
//           onApprove={filterType === "pending" || filterType === "all" ? handleApprove : undefined}
//           onReject={filterType === "pending" || filterType === "all" ? handleReject : undefined}
//           role="admin"
//         />
//       )}
//     </div>

...
//   MdMessage, MdRateReview, MdNotifications, MdPerson, MdHelpOutline, MdLogout
// } from "react-icons/md";
// const navItems = [
...
//   return (
//       <div className="w-64 min-h-screen bg-white shadow-lg border-r sticky top-0 z-10">
//       <h2 className="text-2xl font-bold text-center text-blue-600 py-6 border-b">Owner Dashboard</h2>
